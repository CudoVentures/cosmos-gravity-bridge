...
var (
	...
	pattern_Msg_SetMinFeeTransferToEth_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"gravity", "v1", "set_min_fee_transfer_to_eth"}, "", runtime.AssumeColonVerbOpt(false)))
