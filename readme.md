...
### Here is a list of the changes branches
...
cudos-v0.0.29-feature-Increase-log-level-from-info-to-error

cudos-v0.0.29-fix-wait-transactions

cudos-v0.0.29-fix-batches-timout-calculation

cudos-v0.0.29-fix-eth-address-lowercase

cudos-v0.0.29-feature-automatic-creation-of-batches
...
cudos-v0.0.29-remove-feature-logic-call-creation

cudos-v0.0.29-fix-add-0th-eth-address-checks
