...
/// MsgUpdateBlockHeightClaim
/// When more than 66% of the active validator set has
/// claimed to have seen the same block time
/// the block time is updated
/// -------------
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct MsgUpdateBlockHeightClaim {
    #[prost(uint64, tag="1")]
    pub block_height: u64,
    #[prost(string, tag="2")]
    pub orchestrator: ::prost::alloc::string::String,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct MsgUpdateBlockHeightClaimResponse {
}
